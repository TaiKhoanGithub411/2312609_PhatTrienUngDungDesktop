...
begin
	Update Food set [Name]=@Name, [Unit]=@Unit,
	[FoodCategoryID]=@FoodCategoryID, [Price]=@Price, [Notes]=@Notes
	where [ID]=@ID
end
else if @Action=2
begin
...
exec Food_InsertUpdateDelete 13, N'Bia Sài Gòn', N'Lon', 10, 17000, N'Thử cập nhật', 1